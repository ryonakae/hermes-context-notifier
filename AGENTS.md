...
- Implementation plan: `.hermes/plans/2026-04-28_163039-hermes-context-notifier-plugin.md`
...
Manual Slack validation requires a Hermes gateway restart after enabling or changing this plugin. The gateway imports plugin code at process start.
